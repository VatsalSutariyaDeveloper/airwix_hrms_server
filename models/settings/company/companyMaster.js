module.exports = (sequelize, DataTypes) => {
  const CompanyMaster = sequelize.define("CompanyMaster", {
    ...
    country_id: { type: DataTypes.INTEGER, allowNull: true, defaultValue: 0 },
    state_id: { type: DataTypes.INTEGER, allowNull: true, defaultValue: 0 },
    city: { type: DataTypes.STRING(100), allowNull: true, defaultValue: 0 },
