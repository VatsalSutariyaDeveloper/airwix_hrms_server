module.exports = (sequelize, DataTypes) => {
    const EmployeeLeaveBalance = sequelize.define(
        "EmployeeLeaveBalance",
        {
            ...
            total_allocated: { type: DataTypes.DECIMAL(10, 1), defaultValue: 0 },
            used_leaves: { type: DataTypes.DECIMAL(10, 1), defaultValue: 0 },
            pending_leaves: { type: DataTypes.DECIMAL(10, 1), defaultValue: 0 },
            carry_forward_leaves: { type: DataTypes.DECIMAL(10, 1), defaultValue: 0 },
            unused_leave_rule: {
