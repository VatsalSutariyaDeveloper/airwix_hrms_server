...
// --- Import Controllers ---
// Permission & Modules
const moduleMasterController = require("../controllers/masterAdmin/administration/permission/moduleMasterController");
const moduleEntityMasterController = require("../controllers/masterAdmin/administration/permission/moduleEntityMasterController");
const modulePermissionTypeMasterController = require("../controllers/masterAdmin/administration/permission/modulePermissionTypeMasterController");
const permissionController = require("../controllers/masterAdmin/administration/permission/permissionController");

// Address / Location
const stateMasterController = require("../controllers/masterAdmin/administration/address/stateMasterController");
const countryMasterController = require("../controllers/masterAdmin/administration/address/countryMasterController");

// General Masters
const bankMasterController = require("../controllers/masterAdmin/administration/bankMasterController");
const currencyMasterController = require("../controllers/masterAdmin/administration/currencyMasterController");
const companySettingsMasterController = require("../controllers/masterAdmin/administration/companySettingsMasterController");
const statutoryPTRuleController = require("../controllers/masterAdmin/administration/statutoryPTRuleController");
const statutoryLWFRuleController = require("../controllers/masterAdmin/administration/statutoryLWFRuleController");
const holidayController = require("../controllers/masterAdmin/administration/holidayController");
const approvalActionController = require("../controllers/masterAdmin/administration/approvalActionController");
const approvalMasterController = require("../controllers/masterAdmin/administration/approvalMasterController");
const cronJobController = require("../controllers/masterAdmin/administration/cronJobController");
...
//statutoryLWFRule routes
router.get("/statutory-lwf-rule/:id",statutoryLWFRuleController.getById);
router.post("/statutory-lwf-rule/get-transactions", statutoryLWFRuleController.getAll);
router.post("/statutory-lwf-rule",statutoryLWFRuleController.create);
router.put("/statutory-lwf-rule/:id",statutoryLWFRuleController.update);
router.delete("/statutory-lwf-rule", statutoryLWFRuleController.delete);
router.post("/statutory-lwf-rule/dropdown-list", statutoryLWFRuleController.dropdownList);
router.patch("/statutory-lwf-rule/status", statutoryLWFRuleController.updateStatus);
router.post("/statutory-lwf-rule/states", statutoryLWFRuleController.getStatesWithRules);

// statutoryPTRRuleMaster routes
router.get("/statutory-pt-rule/:id",statutoryPTRuleController.getById);
router.post("/statutory-pt-rule/get-transactions", statutoryPTRuleController.getAll);
router.post("/statutory-pt-rule",statutoryPTRuleController.create);
router.put("/statutory-pt-rule/:id",statutoryPTRuleController.update);
router.delete("/statutory-pt-rule", statutoryPTRuleController.delete);
