...
exports.dropdownList = async (req, res) => {
    try {
        const result = await commonQuery.findAllRecords(AttendanceTemplate, { status: 0 }, { attributes:["id", "name", "mode", "out_duty_approval_level", "out_duty_approval_config", "enble_out_duty"] });
