...
exports.dropdownList = async (req, res) => {
    try {
        const result = await commonQuery.findAllRecords(AttendanceTemplate, { status: 0 }, { attributes:["id", "name", "mode", "on_duty_approval_level", "on_duty_approval_config", "enble_on_duty"] });
