...
const { validateRequest, adminCommonQuery, handleError, sequelize, getCompanySetting } = require("../../../helpers");
...
exports.create = async (req, res) => {
  try {
    ...
    await adminCommonQuery.createRecord(CurrencyMaster, req.body, transaction);
...
exports.getById = async (req, res) => {
  try {
    ...
    const record = await adminCommonQuery.findOneRecord(CurrencyMaster, id, {}, null, false, false);
    ...
    if (default_currency) {
      ...
      const baseCurrency = await adminCommonQuery.findOneRecord(CurrencyMaster, default_currency, {}, null, false, false);
...
exports.update = async (req, res) => {
  ...
  try {
    ...
    const updated = await adminCommonQuery.updateRecordById(CurrencyMaster, req.params.id, req.body, transaction);
...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    const deleted = await adminCommonQuery.softDeleteById(CurrencyMaster, ids, transaction);
    if (!deleted) {
      await transaction.rollback();
