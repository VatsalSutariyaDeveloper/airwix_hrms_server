...
const { sequelize, adminCommonQuery, validateRequest, constants, handleError, Op } = require("../../../../helpers");
...
exports.getAllPermissions = async (req, res) => {
    try {
        const permissions = await adminCommonQuery.findAllRecords(
            Permission, 
            {}, 
            {
            include: [
...
exports.getPermissionHierarchy = async (req, res) => {
    try {
        ...
        const [modules, permissions] = await Promise.all([
            adminCommonQuery.findAllRecords(ModuleMaster, { status: 0 }, {
            ...
            adminCommonQuery.findAllRecords(Permission, {}, {
...
exports.createRoutePermission = async (req, res) => {
    ...
    try {
        ...
        const newRouteRule = await adminCommonQuery.createRecord(RoutePermission, {
...
exports.getAllRoutePermissions = async (req, res) => {
    try {
        ...
        const routes = await adminCommonQuery.fetchPaginatedData(
            RoutePermission,
            cleanedBody,
            fieldConfig,
            {
...
exports.getByIdRoutePermission = async (req, res) => {
    try {
        ...
        const route = await adminCommonQuery.findOneRecord(RoutePermission, id, {
            include: [{
                model: Permission,
                as: 'permission',
                attributes: [],
...
exports.updateRoutePermission = async (req, res) => {
    ...
    try {
        ...
        const updated = await adminCommonQuery.updateRecordById(RoutePermission, id, {
...
exports.deleteRoutePermission = async (req, res) => {
    ...
    try {
        ...
        for (const id of idArray) {
            const deleted = await adminCommonQuery.hardDeleteRecords(RoutePermission, { id }, transaction);
            if (deleted) {
                deletedCount++;
            }
        }
