...
const { sequelize, validateRequest, adminCommonQuery, handleError, constants } = require("../../../../helpers");
...
exports.create = async (req, res) => {
  ...
  try {
    ...
    await adminCommonQuery.createRecord(ModulePermissionTypeMaster, req.body, transaction);
...
exports.getById = async (req, res) => {
  try {
    const record = await adminCommonQuery.findOneRecord(ModulePermissionTypeMaster, req.params.id);
...
exports.update = async (req, res) => {
  ...
  try {
    ...
    const updated = await adminCommonQuery.updateRecordById(ModulePermissionTypeMaster, req.params.id, req.body, transaction);
