...
const { sequelize, validateRequest, adminCommonQuery, handleError, getCompanySetting, constants } = require("../../../../helpers");
...
exports.create = async (req, res) => {
  ...
  try {
    ...
    await adminCommonQuery.createRecord(
      ModuleMaster,
...
exports.getById = async (req, res) => {
  try {
    const record = await adminCommonQuery.findOneRecord(ModuleMaster, req.params.id, {}, null, false, false);
...
exports.update = async (req, res) => {
  ...
  try {
    ...
    const updated = await adminCommonQuery.updateRecordById(ModuleMaster, req.params.id, { ...req.body, company_id: -1, branch_id: -1, user_id: -1 }, transaction, false, false);
...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    const deleted = await adminCommonQuery.softDeleteById(ModuleMaster, ids, transaction, false);
    ...
    await adminCommonQuery.softDeleteById(
      ModuleEntityMaster, 
      { module_id: { [Op.in]: ids } }, 
      transaction,
      false
