...
exports.create = async (req, res) => {
    ...
    try {
        ...
        await adminCommonQuery.createRecord(CountryMaster, req.body, transaction);
...
exports.getById = async (req, res) => {
    try {
        const record = await adminCommonQuery.findOneRecord(CountryMaster, req.params.id);
...
exports.update = async (req, res) => {
    ...
    try {
        ...
        const updated = await adminCommonQuery.updateRecordById(CountryMaster, id, req.body, transaction);
        if (!updated) {
             await transaction.rollback();
...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    const deleted = await adminCommonQuery.softDeleteById(CountryMaster, ids, transaction);
    if (!deleted) {
        await transaction.rollback();
        return res.error(constants.COUNTRY_MASTER_NOT_FOUND);
    }
