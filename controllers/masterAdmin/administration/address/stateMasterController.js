...
exports.create = async (req, res) => {
    ...
    try {
        ...
        await adminCommonQuery.createRecord(StateMaster, req.body, transaction);
...
exports.getById = async (req, res) => {
    try {
        const record = await adminCommonQuery.findOneRecord(StateMaster, req.params.id);
...
exports.update = async (req, res) => {
    ...
    try {
        ...
        const updated = await adminCommonQuery.updateRecordById(StateMaster, id, req.body, transaction);
        if (!updated) {
             await transaction.rollback();
...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    const deleted = await adminCommonQuery.softDeleteById(StateMaster, ids, transaction);
    if (!deleted) {
        await transaction.rollback();
